...
class GameRelVar extends GameVar {
  ...
  constructor(entry: DictEntry) {
    super(entry);
    this.offset = parseInt(entry[KEY_OFF] as string, 16)
  }
...
class GameData extends GameVar {
  ...
  constructor(entry: DictEntry) {
    super(entry);
    this.addr = parseInt(entry[KEY_ADDR] as string, 16)
  }
...
class GameCode extends GameEntry {
  ...
  constructor(entry: DictEntry) {
    super(entry);
    this.addr = parseInt(entry[KEY_ADDR] as string, 16);
    this.size = parseInt(entry[KEY_SIZE] as string, 16);
...
class GameEnumVal extends GameEntry {
  ...
  constructor(entry: DictEntry) {
    super(entry);
    this.val = parseInt(entry[KEY_VAL] as string, 16);
  }
